  ...
  <div class="relative w-full max-w-lg max-h-[calc(100vh-4rem)] overflow-y-auto rounded-2xl bg-white shadow-xl ring-1 ring-stone-950/5">
    ...
    <div class="space-y-6 px-6 py-5">
      <div class="rounded-lg border border-amber-200 bg-amber-50/60 px-4 py-3 text-sm/6 text-amber-900">
        ...
        <p class="mt-2">If your device is locked, our <a href="/#unlock-tool" class="font-medium underline underline-offset-2 hover:text-amber-950">experimental Unlock Tool</a> (Apple Silicon Macs only for now) lets you install CrossPoint over OTA instead of USB.</p>
      </div>
